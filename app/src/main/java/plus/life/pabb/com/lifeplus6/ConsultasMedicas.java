...
public class ConsultasMedicas extends AppCompatActivity {
    ...
    private DatabaseReference dbRef = database.getReference("Consultas");
    ...
    private void addChildEventListener() {
        ChildEventListener childListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                adapter.add(
                        (String) dataSnapshot.child("consulta").getValue());
    ...
    public void addItem(View view) {
        ...
        itemText.setText("");
        dbRef.child(key).child("consulta").setValue(item);
    ...
    public void findItems(View view) {
        ...
        if (!searchMode) {
            ...
            query = dbRef.orderByChild("Consultas").
    ...
    ValueEventListener queryValueListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            while (iterator.hasNext()) {
                ...
                String match = (String) next.child("Consultas").getValue();
