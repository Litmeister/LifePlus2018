...
public class Tratamiento extends AppCompatActivity{
    ...
    private DatabaseReference dbRef = database.getReference("Tratamiento");
    ...
    private void addChildEventListener() {
        ChildEventListener childListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                adapter.add(
                        (String) dataSnapshot.child("tratamiento").getValue());
    ...
    public void addItem(View view) {
        ...
        itemText.setText("");
        dbRef.child(key).child("tratamiento").setValue(item);
    ...
    public void findItems(View view) {
        ...
        if (!searchMode) {
            ...
            query = dbRef.orderByChild("Tratamiento").
